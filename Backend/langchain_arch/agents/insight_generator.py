...
class InsightGeneratorAgent:
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f"CRITICAL: Failed to initialize LLM or Async Mem0 in InsightGeneratorAgent: {e}")
    ...
    async def run(self, query: str, data: Dict[str, List[Dict[str, Any]]], user_id: str, query_generation_reasoning: str) -> Optional[Dict[str, Any]]:
        """
        Executes the insight generation chain using ainvoke, saves the interaction asynchronously,
        and returns the final insight dictionary or None on error.
