"""
Tool for triggering Facebook Ads Optimization workflows via the FastAPI backend.
"""
...
async def facebook_optimization_trigger(tool_input: str) -> str:
    """
    Triggers a Facebook Ads Optimization workflow in the backend.
    ...
    try:
        ...
        endpoint = f"{backend_url}/api/v1/workflows/trigger/facebook_optimization"
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200:
                ...
                return f"Facebook Ads optimization analysis started (workflow ID: {workflow_id}). Results will appear in the dashboard shortly."
            else:
...
facebook_optimization_trigger_tool = Tool(
    name="facebook_optimization_trigger",
    description="""
    Useful for answering questions about how to optimize Facebook Ads campaigns or improve performance.
    Use this tool when the user asks for recommendations, suggestions, or ways to improve their Facebook ads,
    such as reducing costs, increasing engagement, optimizing targeting, or improving ad set performance.
    The analysis will be displayed in the dashboard.
    The input must be a JSON string with "query" and "session_id" fields.
    Example input: {"query": "how to optimize my Facebook campaigns", "session_id": "user-123456"}
    """,
    func=lambda x: None,  # Placeholder
    coroutine=facebook_optimization_trigger,
