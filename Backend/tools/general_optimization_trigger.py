...
class GeneralOptimizationTriggerTool(BaseTool):
    name: str = "GeneralOptimizationTrigger"
    description: str = (
        "Triggers a general optimization workflow that combines recommendations from Google and Facebook. "
        "Use this for broad questions about improving campaign performance across all platforms, or when the user asks for optimization recommendations across platforms. "
        "The input must be a JSON string with 'query' and 'session_id' fields. "
        "Example input: {\"query\": \"how can I improve my campaigns\", \"session_id\": \"user-123\"}. "
    ...
    async def _arun(self, tool_input: str, **kwargs: Any) -> Dict[str, Any]:
        ...
        print(f"[GeneralOptimizationTriggerTool Debug] Received raw tool_input: {tool_input}")
        ...
        try:
            ...
            print(f"ERROR in GeneralOptimizationTriggerTool: {error_message}")
            ...
            print(f"[GeneralOptimizationTriggerTool Recovery] Extracted via regex: query='{query}', session_id='{session_id}'")
        ...
        print(f"[GeneralOptimizationTriggerTool Debug] Parsed query: {query}, session_id: {session_id}")

        endpoint_url = f"{BACKEND_API_URL}/api/v1/workflows/trigger/general_optimization"
    ...
    def _run(self, tool_input: str, **kwargs: Any) -> Dict[str, Any]:
        ...
        raise NotImplementedError("Synchronous execution is not implemented for GeneralOptimizationTriggerTool. Use arun.")
...
if __name__ == '__main__':
    ...
    async def main():
        ...
        test_query = "How can I improve my campaigns overall?"
        
        tool = GeneralOptimizationTriggerTool()
