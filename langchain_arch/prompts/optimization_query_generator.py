...
8.  **Dont restrict to certain date ranges:** The queries should not be restricted to certain date ranges unless the user explicitly requests so. The queries should be able to run for any date range.
9.  **Dont use arbitrary performance thresholds:** The queries should not be restricted to certain performance thresholds unless the user explicitly requests so. Sort the metrics and get the lowest or highest performers.
